    ...
    return (
        <>
            ...
            <main className="main">
                ...
                <MoviesCardList buttonName="delete" movies={props.movies} isLoading={props.isLoading} handleClick={props.handleClick} handleDeleteMovie={props.handleDeleteMovie} savedMovies={props.savedMovies} buttonShowMore={props.buttonShowMore} />
            </main>
            <Footer />
        </>
    );
