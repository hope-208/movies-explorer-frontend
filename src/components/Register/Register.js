...
function Register(isLoggedIn) {
    ...
    return (
        <Form formName="register" isLoggedIn={isLoggedIn} >
            ...
            <Input name="password" type="password" title="Пароль" minLength="6" isLoggedIn={isLoggedIn} placeholder="Введите пароль." />
            <Error textError="Что-то пошло не так..." />
            <div className='form__footer'>
                <Button buttonClassName="button-sign button-sign-up" buttonName="signup" buttonTitle="Зарегистрироваться" />
